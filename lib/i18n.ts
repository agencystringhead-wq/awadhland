...
export const ui = {
  en: {
    ...
    circleRateLookup: "Circle rate lookup",
    plotYieldCalculator: "Plot yield calculator",
    whatCouldThisEarn: "What could this plot earn?",
    landSafetyChecklist: "Land safety checklist",
    beforeYouBuy: "Before you buy: 30-point checklist",
    beforeYouBuyBody: "Khatauni, title chain, Gram Sabha land, registry and mutation: every check in order.",
    ...
    checkCircleRates: "Check circle rates",
  ...
  hi: {
    ...
    circleRateLookup: "सर्किल रेट खोजें",
    plotYieldCalculator: "प्लॉट रिटर्न कैलकुलेटर",
    whatCouldThisEarn: "यह प्लॉट कितना कमा सकता है?",
    landSafetyChecklist: "ज़मीन सुरक्षा चेकलिस्ट",
    beforeYouBuy: "ख़रीदने से पहले: 30 जाँचों की चेकलिस्ट",
    beforeYouBuyBody: "खतौनी, स्वामित्व-श्रृंखला, ग्राम सभा की ज़मीन, रजिस्ट्री और दाख़िल-ख़ारिज: हर जाँच क्रम से।",
    ...
    checkCircleRates: "सर्किल रेट देखें",
