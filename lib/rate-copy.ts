...
export const rateCopy = {
  en: {
    ...
    coveredRates: "Construction (covered area)",
    kindCovered: "Covered area (construction)",
    coveredGrade: "Construction grade",
    ratesPending: "Rate list not published here yet",
  ...
  hi: {
    ...
    kindCovered: "निर्मित क्षेत्र (निर्माण)",
    coveredGrade: "निर्माण की श्रेणी",
    ratesPending: "इस एसआरओ की दर सूची अभी नहीं आई",
